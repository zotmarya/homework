...
public class FrequencyDictionaryTest {
    ...
    static Stream<Arguments> keysAndValues() {
        return Stream.of(
            ...
            Arguments.arguments(
                new ArrayList<>(List.of("this", "and", "that", "and")),
                Map.of("that", 1, "and", 2, "this", 1)
            ),
            Arguments.arguments(
                new ArrayList<>(List.of("код", "код", "код", "bug")),
                Map.of("код", 3, "bug", 1)
            ),
    ...
    void makeFrequencyDictionary_WhenGivenStrings_ReturnsFrequencyHashMap(
        ArrayList<Object> givenList,
        Map<Object, Integer> expectedDictionary
    ) {
        Map<Object, Integer> resultHashMap = frequencyDictionary.makeFrequencyDictionary(givenList);
